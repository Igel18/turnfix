...
const NAME_KEY_MAP: Record<string, string> = {
  ...
  'Rounds':                   'managementCenter.eventManagement.timePlanning.rounds.title',
  'Rotation':                 'managementCenter.eventManagement.timePlanning.rotation.title',
  'Schedule Matrix':          'managementCenter.eventManagement.timePlanning.matrix.title',
...
const DESC_KEY_MAP: Record<string, string> = {
  ...
  'Rounds':                   'managementCenter.eventManagement.timePlanning.rounds.description',
  'Rotation':                 'managementCenter.eventManagement.timePlanning.rotation.description',
  'Schedule Matrix':          'managementCenter.eventManagement.timePlanning.matrix.description',
