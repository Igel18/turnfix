...
export default defineConfig({
  ...
  projects: [
    ...
    // ── Dependent tests: Need setup data ──
    {
      name: 'tests',
      dependencies: ['setup'],
      testMatch: /tests\/(score-entry|results|competition|import-verification|placement|statistical|jury-portal|status|pdf-export|load-test|team-competition|time-planning|group-scoring|team-scoring|squad-status|live-scores|medallienspiegel)\.spec\.ts/,
      use: { ...devices['Desktop Chrome'] },
