...
export async function applyGymNetPreset(customPrismaClient?: PrismaClient) {
  ...
  const geraete = [
    ...
    { name: 'Ringe P1-P9', anzeigename: 'Ringe P1-P9', kurzname: 'RINGP', eingabemaske: '0.00', einheit: 'Pkt.', symbol: ':/icons/ringe.png', formula: 'P-Wettkampf', sport: 'Turnen DTB P', bol_m: true, bol_w: false, isP: true },
