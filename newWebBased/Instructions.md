# 📋 Inhaltsverzeichnis - TurnFix v2.0 Instructions

_Generiert am: 2025-11-04 14:19_
...
- 🚧 **In Arbeit** - Punkt wird aktuell bearbeitet
- ⏳ **Offen** - Punkt noch nicht begonnen
- ❌ **Abgebrochen** - Punkt wird nicht umgesetzt

---

✅ [1. in veranstaltungsverwaltung muss es einen button geben um die Startnummern zu generieren](#punkt-1)
✅ [2. in der Ansicht "Event Participants" ist nich lokalisiert](#punkt-2)
✅ [3. in der Ansicht "Event Participants" funktioniert der Filter mit den AgeGroups nicht. ich denke es ist ausreichend nach Age zu filtern.](#punkt-3)
✅ [4. die Ansicht "Manage Squads" ist nicht lokalisiert](#punkt-4)
✅ [5. in der Ansicht "Manage Squads" benötige ich eine neue FUnktion: Bei Auswahl eines Wettkampfes in den Riegen Details (rechte Spalte) "assigned Competitions" sollen alle Teilnehmer von diesem Wettkampf gehighlightet werden.](#punkt-5)
✅ [6. in der Ansicht "Manage Squads" kann man aktuell nicht nach Vereinen Filtern.](#punkt-6)
✅ [7. Lokalisierung der aller UIs im Veranstaltungsverwaltung die noch nicht lokalisiert sind.](#punkt-7)
✅ [8. In der View http://localhost:5173/certificate-layouts beim Editieren eines Layouts sind die DB Felder durch nummeriert. Es ist nicht klar was dahinter steckt... lässt sich irgendwie raus finden was die Felder bedeuten? Im Alten c++ code waren die felder genau benannt.](#punkt-8)
✅ [9. Auf der Seite Veranstaltungsteilnehmer gibt es einen Export "Teilnehmer Etiketten" diese Etiketten müssen sortiert werden nach Gender dann Riege dann Verein.](#punkt-9)
✅ [10. Gender in den Participant listen ist oft unknown. Bei den Veranstaltungsteilnehmern passt es aber. Gibt es da keine helper oder util oder andere generelle klasse die das handelt? ggf. könnte man die von den Veranstaltungsteilnehmern auch bei den participants verwenden.](#punkt-10)
⏳ [11. Setup so gestalten, dass mit einem klick alles installiert wird, so wie ich das sehe ist das u.a.](#punkt-11)
✅ [12. Wird die Seite "event-management" bearbeitet und soll dann gespeichert werden, kann man den speicher button nicht finden, da dieser ganz weiß ist.](#punkt-12)
✅ [13. Lokalisierung der kompletten Einstellungen http://localhost:5173/configuration](#punkt-13)
✅ [14. Veranstaltungsteilnehmer: Die Suche muss auch für die Startnummern funktionieren.](#punkt-14)
✅ [15. Athletes Management lokalisieren](#punkt-15)
✅ [16. Athletes Management Filter "Gender" hat kein "unknown" aber "allgender" und "allgenders"](#punkt-16)
✅ [17. Athletenverwaltung Dialog zum editieren ist nicht lokalisiert](#punkt-17)
✅ [18. Jury Portal: Icons von den disziplinen verwenden, die auch bei diesen hinterlegt sind. vielleicht gibt es dafür schon generalized funktionen?](#punkt-18)
✅ [19. im Jury Portal beim Eingeben der Wertungen steht im header das Gerät. Hier wäre die Anzeige des Icons auch noch hilfreich.](#punkt-19)
✅ [20. was ist der unterschied zwischen den jury portalen? kann man hier den selben code verwenden? oder vielleicht sogar das Client Jury Portal eleminieren?](#punkt-20)
✅ [21. http://localhost:5173/management ist folgendes nicht lokalisiert: "Select Event"](#punkt-21)
✅ [11. Setup so gestalten, dass mit einem klick alles installiert wird, so wie ich das sehe ist das u.a.](#punkt-11)
⏳ [22. Jury-Results:](#punkt-22)
⏳ [23. die Seite http://localhost:3001/disciplines und der Dialog (Edit Discipline)](#punkt-23)
✅ [24. auf der seite http://localhost:3001/configuration sind in den Anwendungseinstellungen ist der ClientPort angegeben. Dieser passt aber nicht ganz, ich denke das ist nicht der production sondern der develop](#punkt-24)
✅ [25. mit aktiver Check-Box Jury results](#punkt-25)
✅ [26. Das Beschreibungsfeld beim editieren von Layouts kann nicht geändert / beschrieben werden. http://localhost:3001/certificate-layouts](#punkt-26)
✅ [27. wäre diese anpassung mit dem singelton dann nicht bei jeder route zu machen?](#punkt-27)
✅ [28. Seit Discipline Fields Management (http://localhost:3001/discipline-fields)](#punkt-28)
✅ [29. Aufräumen & Refactoring](#punkt-29)
✅ [30. unification von male / female / both / undefined in den UIs](#punkt-30)
✅ [31. lokalisierung.](#punkt-31)
✅ [32. Usability allgemein:](#punkt-32)
✅ [33. in allen UIs: alle Tabellen haben überschriften. es wäre schön, wenn man auf diese klicken kann um die Liste zu sortieren (aufsteigen/absteigend)](#punkt-33)
⏳ [34. Druck / Export](#punkt-34)
✅ [35. UI unification](#punkt-35)
✅ [36. Lokalisierung](#punkt-36)
✅ [37. Veranstaltungsteilnehmer](#punkt-37)
✅ [38. GymNet (Wettkampf) Import](#punkt-38)
✅ [39. Sortieren der Tabellen fehlt](#punkt-39)
✅ [40. Default Table-View Verification](#punkt-40)
✅ [41. Hilfe texte per default ausblenden. und über einen Button einblenden wie in dieser View:](#punkt-41)
✅ [42. nach dem öffenen des editors auf der Seite Wettkampfverwaltung http://localhost:3001/competitions?eventId=59&squadName=mBlau](#punkt-42)
✅ [43. Wettkampfverwaltung](#punkt-43)
✅ [44. Sortierung](#punkt-44)
✅ [45. Sind alle Möglichkeiten für die Wettkampfteilnehmer implementiert? Es müsste neben dem "Nimmt nicht teil" eine checkbox "Außer Konkurenz" geben. Und ein Kommentarfeld.](#punkt-45)
✅ [46. Im Kampfrichter Portal werden die Geräte nicht als Icons angezeigt. Es steht nur un Text in den Buttons](#punkt-46)
✅ [47. Das Import Log Fenster beim Import von GymNet ist noch nicht lokalisiert. Und auch noch nicht die "Import Information".](#punkt-47)
✅ [48. In der Wettkampfverwaltung steht bei Altersgruppe 18-100 im editieren 18-18](#punkt-48)
✅ [49. Lokalisierung auf der Seite http://localhost:3001/events](#punkt-49)
✅ [50. auf der Seite http://localhost:3001/competitions?eventId=77&squadName=mBlau gibt es keine Umschaltmöglichkeit der Sprache. Hier gibt es diese: http://localhost:3001/event-participants?eventId=77&squadName=mBlau](#punkt-50)
✅ [51. macht das sinn UnifiedHeader und UnifiedPageHeader zusammenzuführen?](#punkt-51)
✅ [52. Browser Icon](#punkt-52)
✅ [53. Riegen status](#punkt-53)
✅ [55. Tabelle lässt sich nicht sortieren](#punkt-55)
✅ [56. ](#punkt-56)
✅ [57. ](#punkt-57)
✅ [58. ](#punkt-58)
✅ [62. Prio 1 Wertungen werden nicht richtig gespeichert. Sowohl im Jury als auch in der Wertungserfassung. Diese sind zwar synchron, aber die Werte werden nicht in Turnfix angezeigt. Wahrscheinlich wird beim Leistung erfassen die Person einem Anderen Wettkampf zusätzlich zugeordnet und darum wird die Wertung nicht in dem korrekten gespeichert.](#punkt-62)
✅ [63. Prio 1](#punkt-63)
✅ [64. ](#punkt-64)
⏳ [68. pdf dokumente serverseitig generieren und dann runterladen.](#punkt-68)
✅ [72. ](#punkt-72)
✅ [76. ](#punkt-76)
⏳ [1. (`server/src/utils/portChecker.ts`):](#punkt-1)
⏳ [2. (`server/src/scripts/check-port.ts`):](#punkt-2)
⏳ [3. (`server/src/index.ts`):](#punkt-3)
✅ [78. ](#punkt-78)
✅ [79. Prio 10 Live-Updates](#punkt-79)
⏳ [1. Client verbindet und emittet `join-competition` mit eventId](#punkt-1)
⏳ [2. Server fügt Client zu Room `competition-${eventId}` hinzu](#punkt-2)
⏳ [3. Bei Score-Save: Server lädt Details aus DB und emittet `score-updated`](#punkt-3)
⏳ [4. Alle Clients im Room empfangen Update in Echtzeit](#punkt-4)
⏳ [5. Client zeigt neue Wertung mit fadeIn-Animation an](#punkt-5)
✅ [80. ](#punkt-80)
✅ [82. ](#punkt-82)
⏳ [1. (`client/src/utils/scoreFormatter.ts`):](#punkt-1)
⏳ [2. :](#punkt-2)
⏳ [3. :](#punkt-3)
⏳ [4. :](#punkt-4)
✅ [81. Wettkampfstatus umsetzen als Matrix view mit dem Template](#punkt-81)
⏳ [82. Prio 3 Einheitliche Eingabe-/Anzeige format für die Wertungen:](#punkt-82)
⏳ [83. Medallienspiegel:](#punkt-83)
❌ [1. ❌ Unicode-Zeichen "✓ LÄUFT" als "LÄ"UFT"" angezeigt](#punkt-1)
❌ [2. ❌ $PSScriptRoot leer → Join-Path Fehler](#punkt-2)
❌ [3. ❌ PM2 CommandNotFoundException](#punkt-3)
❌ [4. ❌ .bat Script hängt bei Version-Check](#punkt-4)
❌ [5. ❌ ecosystem.config.js nicht gefunden](#punkt-5)
❌ [6. ❌ -OutputEncoding Parameter Fehler](#punkt-6)
❌ [7. ❌ ecosystem.config.js nicht in Git](#punkt-7)
❌ [8. ❌ dist/ Ordner fehlt nach Git-Clone](#punkt-8)
⏳ [1. Git Clone Repository](#punkt-1)
⏳ [2. TurnFix-Manager.bat starten](#punkt-2)
⏳ [3. Script prüft automatisch:](#punkt-3)
⏳ [4. PM2 startet Server automatisch](#punkt-4)
✅ [5. ](#punkt-5)
⏳ [86. Prio 10 Es gibt verschiedene UI elemente](#punkt-86)
⏳ [87. Prio 9 Analysiere mal den ganzen QT Code hinsichtlich Gruppen und Mannschaftswettkämpfe](#punkt-87)
✅ [88. Prio 5 Es gibt einen Ordner client/dist-jury/index-jury.html - Dieser ist denke ich obsolet, da der richtige Jury portal über die ordner jury-portal und jury-server abgebildet werden. Bitte prüfen und ggf. archivieren.](#punkt-88)
✅ [89. Prio 1 Das Feld Geschlecht scheint in der http://localhost:3001/event-participants?eventId=59&squadName=m Edit view nicht bei weiblich nicht zu stimmen. da wird immer männlich angezeigt.](#punkt-89)
✅ [90. ](#punkt-90)
⏳ [1. (`client/tailwind.config.js`):](#punkt-1)
⏳ [2. :](#punkt-2)
⏳ [3. (automatisch breiter):](#punkt-3)
⏳ [91. Prio 5 status:](#punkt-91)
✅ [92. Prio 1](#punkt-92)
✅ [93. ](#punkt-93)
⏳ [1. :](#punkt-1)
⏳ [2. :](#punkt-2)
...
⏳ [5. :](#punkt-5)
⏳ [1. :](#punkt-1)
⏳ [2. : Neuer Hook (26 Zeilen)](#punkt-2)
⏳ [3. :](#punkt-3)
⏳ [1. - Region create/edit modal](#punkt-1)
⏳ [2. - Association create/edit modal](#punkt-2)
⏳ [3. - Event create/edit modal](#punkt-3)
⏳ [4. - Import GymNet XML modal](#punkt-4)
⏳ [5. - Add Participant modal (size: 2xl, fullHeight)](#punkt-5)
⏳ [6. - Label Configuration modal (size: 2xl, fullHeight)](#punkt-6)
⏳ [7. - Edit Participant modal (size: 2xl, fullHeight)](#punkt-7)
⏳ [8. - Certificate printing modal (size: md)](#punkt-8)
⏳ [9. - Time Settings modal (size: 2xl)](#punkt-9)
⏳ [10. - Create Squad modal (size: md)](#punkt-10)
⏳ [11. - Club create/edit form (size: 2xl) - 181 lines](#punkt-11)
⏳ [12. - Sport create/edit form (size: md) - 100 lines](#punkt-12)
⏳ [13. - Location/venue form (size: 2xl) - 109 lines](#punkt-13)
⏳ [14. - Formula configuration (size: md) - 140 lines](#punkt-14)
⏳ [15. - Participant details (size: md) - 158 lines](#punkt-15)
⏳ [16. - Person/contact form (size: 2xl) - 175 lines](#punkt-16)
⏳ [17. - Status configuration (size: md) - 217 lines](#punkt-17)
⏳ [18. - Discipline field settings (size: 2xl) - 248 lines](#punkt-18)
⏳ [19. - Discipline grouping (size: 2xl) - 259 lines](#punkt-19)
⏳ [20. - Discipline configuration (size: 4xl) - 473 lines](#punkt-20)
⏳ [21. - Competition creation (size: 4xl) - 872 lines](#punkt-21)
⏳ [22. - Competition creation v2 (size: 4xl) - 801 lines](#punkt-22)
⏳ [94. Modale Dialog (OBSOLET - siehe Point 93)](#punkt-94)
⏳ [94. Lokalisierung:](#punkt-94)
✅ [95. ](#punkt-95)
⏳ [96. ](#punkt-96)
✅ [97. ](#punkt-97)
✅ [98. ](#punkt-98)
...
✅ [100. ](#punkt-100)
✅ [101. ](#punkt-101)
⏳ [1. - View-Toggle mit Persistence, Filters, Add/Edit/Delete](#punkt-1)
⏳ [2. (Commit: a5abd34c) - View-Toggle, PDF Export, Socket.IO Live-Updates (344 lines)](#punkt-2)
⏳ [3. (Commit: 8a81db9b) - Matrix View, Gender Filter, Club Search, PDF/Print + Point 100 Fix (457 lines)](#punkt-3)
⏳ [4. (Commit: e94f7831) - 3-View Toggle, Squad/Discipline Filters, Generate Combinations, Socket.IO (830 lines)](#punkt-4)
⏳ [5. (Commit: 20892a08) - Matrix/Table/Grid Views, Status/Gender Filters, Progress Tracking, Socket.IO (839 lines)](#punkt-5)
⏳ [6. (Commit: e463dace) - Dashboard, Statistics, Start Numbers, Edit Mode, PDF Export (953 lines)](#punkt-6)
⏳ [7. (Commit: 70dc2fed) - Drag & Drop, Virtual Squads, Gender/Competition/Club Filters, PDF/CSV Export (1071 lines)](#punkt-7)
⏳ [8. (Commit: c984ac7c) - Multi-Competition Support, Certificate Generation, Competition/Gender Filters, PDF/CSV/Print, Toggle Discipline Scores (1791 lines)](#punkt-8)
⏳ [9. (Commit: b8a11a07) - CRUD, Search, Filters, Add Modal, Competitions Assignment (1940 lines)](#punkt-9)
⏳ [10. - Refactored (Commit: 09e44236) + Converted (Commit: 75caa1c4) - Score Entry with Point 93 Keyboard Nav, Component Extraction (2201→1913 lines, -13%)](#punkt-10)
✅ [11. (Commit: 2d05c5fb) -](#punkt-11)
⏳ [12. (Commit: aa26686a) - Gantt Chart, Time Calculations, Rotation Planning + Point 99 Fix (1009→946 lines, -6%)](#punkt-12)
⏳ [1. Main Header (Titel, Buttons, Navigation)](#punkt-1)
⏳ [2. Action Buttons Row (Add, Import, View Toggle)](#punkt-2)
⏳ [3. Event Context Badge](#punkt-3)
⏳ [4. Filters Section](#punkt-4)
⏳ [5. Help Panel Section](#punkt-5)
⏳ [103. Refactoring](#punkt-103)
✅ [104. Inhaltsverzeichnis](#punkt-104)
⏳ [106. chatmode](#punkt-106)
⏳ [107. Im ScoreCapture haben wir ein refactoring gemacht. können teile davon wo anders verwendet werden?](#punkt-107)
⏳ [1. : `LiveUpdateIndicator.tsx`](#punkt-1)
⏳ [2. : `LIVE_UPDATE_INDICATOR.md`](#punkt-2)
⏳ [3. (de.json, en.json):](#punkt-3)
⏳ [4. : `CompetitionStatusManagement`](#punkt-4)
⏳ [109. Zeit Planung](#punkt-109)
⏳ [110. Wettkampfstatus](#punkt-110)
⏳ [111. Filter Lokalisierung](#punkt-111)
⏳ [112. Wettkampfverwaltung](#punkt-112)
⏳ [113. Header nicht einheitlich: muss noch genau definiert werden!](#punkt-113)
✅ [114. Startzeit / Einturnzeit](#punkt-114)
⏳ [115. Bei der Zeitplanung](#punkt-115)
✅ [116. Startnummer vs. Startpassnummer.](#punkt-116)
⏳ [117. Doku](#punkt-117)
✅ [118. Nach UI Styleguide](#punkt-118)
⏳ [119. Bei den Urkunden Layouts fehlt der Filter-Button](#punkt-119)
⏳ [120. pm2 bietet ja ein integrirtes Dashboard welches über http://localhost:9615 erreichbar sein müsste. ist das auch bereits installiert? Sollten wir turnfix-server und jury-server mittels diesem dashboard überwachen, statt mit der console?](#punkt-120)
⏳ [121. die "Rotation Übersicht (Round Robin)" muss für jede Bahn separat erstellt werden.](#punkt-121)
⏳ [122. Refactoring: SoC - Separation of Concerns](#punkt-122)
⏳ [123. bezüglich SoC sollten wir das für alle Client Seiten-Dateien (client/src/pages) umsetzen.](#punkt-123)
⏳ [1. �  - 1.917 Zeilen (40% erledigt, Components ausstehend)](#punkt-1)
⏳ [2. 🚨  - 1.173 Zeilen (sehr hoch)](#punkt-2)
⏳ [3. 🚨  - 1.023 Zeilen](#punkt-3)
⏳ [4. 🚨  - 896 Zeilen](#punkt-4)
⏳ [5. 🚨  - 853 Zeilen](#punkt-5)
⏳ [6. 🚨  - 851 Zeilen](#punkt-6)
⏳ [7. 🚨  - 828 Zeilen](#punkt-7)
⏳ [8. 🚨  - 806 Zeilen](#punkt-8)
⏳ [9. ⚠️  - 797 Zeilen](#punkt-9)
⏳ [10. ⚠️  - 764 Zeilen](#punkt-10)
⏳ [124. Auf der Seite Zeitplanung](#punkt-124)
⏳ [125. Ist SoC auch für den Server möglich (z.B. Route-Datei, Controller-Datei, Service-Datei)? Dann sollten wir das umsetzen und dokumentieren und auch in der myown mit aufnehmen.](#punkt-125)
⏳ [126. Refactoring durchführen und dokumentieren:](#punkt-126)
⏳ [127. auf der Seite](#punkt-127)
⏳ [128. Auf der Seite](#punkt-128)
✅ [1. Hook-Signaturen vereinfachen (zirkuläre Dependencies entfernen)](#punkt-1)
✅ [2. useScoreActions extrahieren (saveScore, saveFieldScore, calculateDisciplineScores)](#punkt-2)
✅ [3. useScoreLiveUpdates extrahieren (Socket.IO Integration)](#punkt-3)
⏳ [4. Clean Orchestration Layer in `index.tsx` erstellen (wie TimePlanning/index.tsx)](#punkt-4)
⏳ [5. Funktionstest (Score-Speicherung, Echtzeit-Updates, CSV-Export)](#punkt-5)
⏳ [6. Nach erfolgreichem Test: `_archive/ScoreCapture.tsx` löschen](#punkt-6)
⏳ [1. - Durchgänge-Übersicht mit Wettkämpfen](#punkt-1)
⏳ [2. - Zeitstrahl (Placeholder)](#punkt-2)
⏳ [3. - Geräte-zentriertes Gantt-Chart](#punkt-3)
⏳ [4. - Bereits separiert (`TimePlanningRotation.tsx`, 538 Zeilen)](#punkt-4)
⏳ [1. Components extrahieren (6 Dateien)](#punkt-1)
⏳ [2. Hooks extrahieren (4 Dateien)](#punkt-2)
⏳ [3. Main Orchestration in index.tsx (~200 Zeilen)](#punkt-3)
⏳ [4. Build testen und TypeScript-Fehler beheben](#punkt-4)
⏳ [5. Funktionalität verifizieren](#punkt-5)
...
In dieser Datei brauche ich ein Inhaltsverzeichnis verlinkung auf die einzelnen punkte und mit ansicht ob der Punkt offen, erledigt oder in Arbeit ist. 

**Status**: ✅ ABGESCHLOSSEN (2025-11-04)

**Implementierung**:
- Vollständiges Inhaltsverzeichnis mit 221 Punkten erstellt
- Status-Anzeige (✅ Erledigt / 🚧 In Arbeit / ⏳ Offen / ❌ Abgebrochen)
- Direktverlinkung zu allen Punkten via Anker (#punkt-N)
- Fortschrittsanzeige mit Statistik:
  * 84 Punkte erledigt (38%)
  * 0 Punkte in Arbeit
  * 129 Punkte offen (58.4%)
  * 8 Punkte abgebrochen (3.6%)
- Visueller Fortschrittsbalken
- Automatisches Generierungs-Timestamp
...
- Datei > 800 Zeilen muss refaktoriert werden
- Datei > 1500 Zeilen ist kritisch, erfordert sofortiges Refactoring
- Ziel: Aufteilung in Components, Hooks, Types

### Umgesetztes Refactoring
...
**Vorher**:
- 1 Datei: `ScoreCapture.tsx` (1,987 Zeilen)
...
- Abhängigkeiten: Disziplin disabled ohne Squad
- ✅ Vollständige DE/EN-Lokalisierung

##### 2. SquadStatusSelector.tsx (68 Zeilen)
**Zweck**: Visueller Status-Indikator + Dropdown
- Farbcodierter Status-Punkt
- Status-Auswahl-Dropdown
- Nur sichtbar wenn Squad + Disziplin ausgewählt
- `getStatusColor()`-Integration
- ✅ Vollständige DE/EN-Lokalisierung

##### 3. ScoreTable.tsx (241 Zeilen)
**Zweck**: Haupt-Eingabetabelle für Wertungen
- Teilnehmer-Zeilen mit Sticky-Spalte
- Disziplin-Spalten
- Inline Score-Eingabe
- Tastatur-Navigation (Pfeile, Enter)
- Echtzeit-Validierung (Farbcodierung)
- Max-Score-Anzeige
- Startnummer-Badges
- Wettkampf-Zuweisung-Display
- Single-Field-Modus (Standard)
- Multi-Field-Modus (Platzhalter vorbereitet)
- 12 ungenutzte Parameter auskommentiert für zukünftige Features
- ✅ Vollständige DE/EN-Lokalisierung

##### 4. HelpPanel.tsx (64 Zeilen)
**Zweck**: Kontext-sensitive Hilfe
- Jury-Scores-Hilfe
...
##### 1. useScoreData.ts (256 Zeilen)
**Zweck**: Daten-Fetching & -Management
- Lädt: Participants, Disciplines, Squads, Competitions, Statuses, Scores
- Debounced API-Calls (100ms Verzögerung)
- Duplikat-Entfernung
- Error-Handling
- Zentralisiertes `loadInitialData()`

**Return**:
```typescript
{
  participants, disciplines, disciplineFields,
  squads, competitions, statuses, existingScores,
  squadDisciplineStatuses, loading, isInitializing,
  loadInitialData, setters...
}
```

##### 2. useScoreMatrix.ts (204 Zeilen)
**Zweck**: Score-Matrix-State-Management
- Initialisiert Score-Matrix aus existierenden Werten
- Normalisiert Werte (`normalizeScoreInput`)
- Squad-basiertes Filtering
- Lädt Werte für Teilnehmer × Disziplinen

**Return**:
```typescript
{
  scoreMatrix, pendingEndwerts,
  setScoreMatrix, setPendingEndwerts,
  initializeScoreMatrix
}
```

##### 3. useFormulaCalculation.ts (116 Zeilen)
**Zweck**: Formel-Auswertung & -Parsing
- Formel-Evaluation mit A-J-Variablen
- Dynamisches Field-to-Variable-Mapping via `sortOrder`
- Display-Formel-Parsing (ersetzt Variablen durch Feldnamen)
...
```
Formula: "A + B - C"
Fields (sortOrder): D-Note (0), E-Note (1), ND (2)
→ Display: "Endwert = D-Note + E-Note - ND"
→ Evaluate: evaluateFormula("A + B - C", { "D-Note": 5.0, "E-Note": 8.5, "ND": 0.3 })
            = 5.0 + 8.5 - 0.3 = 13.2
```

##### 4. useScoreValidation.ts (155 Zeilen)
**Zweck**: Validierung & Filtering
- Score-Validierung (Max-Werte, Dezimalstellen)
- Status-Farben (`getStatusColor`)
- Teilnehmer-Wettkampf-Zuweisung
- Gefilterte Teilnehmer-Liste (Squad + Suche)
...
- `Squad`, `Competition`, `Status`, `Score`
- `ScoreValidation`
...
scoreCapture: {
  ...
  selectSquadFirst,
  filters: { squad, discipline, showJuryScores },
  status: { label },
  table: { startNumber, name, competition, squad },
  help: {
    juryScores: { title, step1-4 },
    navigation: { title, enter, arrows, esc }
  },
  exportCSV
}
```
...
**Code-Qualität**:
- ✅ SoC-Prinzipien angewendet (Separation of Concerns)
...
- ✅ Import-Pfade in Archiv-Datei korrigiert (`../` → `../../`)
- ✅ Konsistent mit EventParticipants-Refactoring (siehe Point 122)

**Dokumentation**:
- ✅ Inline-Kommentare in allen Dateien
- ✅ JSDoc für Funktionen
- ✅ README-artige Kommentare in `index.tsx`
- ✅ TypeScript-Interfaces dokumentiert

#### 📁 Geänderte Dateien

**Neu erstellt**:
- `client/src/pages/ScoreCapture/index.tsx`
- `client/src/pages/ScoreCapture/ScoreCapture.types.ts`
- `client/src/pages/ScoreCapture/components/ScoreFilters.tsx`
- `client/src/pages/ScoreCapture/components/SquadStatusSelector.tsx`
- `client/src/pages/ScoreCapture/components/ScoreTable.tsx`
- `client/src/pages/ScoreCapture/components/HelpPanel.tsx`
- `client/src/pages/ScoreCapture/components/index.ts`
- `client/src/pages/ScoreCapture/hooks/useScoreData.ts`
- `client/src/pages/ScoreCapture/hooks/useScoreMatrix.ts`
- `client/src/pages/ScoreCapture/hooks/useFormulaCalculation.ts`
- `client/src/pages/ScoreCapture/hooks/useScoreValidation.ts`

**Verschoben**:
- `client/src/pages/ScoreCapture.tsx` → `client/src/pages/_archive/ScoreCapture.tsx`

**Modifiziert** (Import-Pfade korrigiert):
- `client/src/pages/_archive/ScoreCapture.tsx` (1,987 Zeilen)
  - Alle `../` Imports → `../../` (components, contexts, utils)

#### 🎓 Lessons Learned

**Hook-Design**:
- Einfache, unabhängige Hooks sind leichter zu integrieren
- Zirkuläre Dependencies zwischen Hooks vermeiden
- Parameter-Listen kurz halten (< 5 Props)
- Klare Trennung: Data vs. State vs. Logic

**Refactoring-Strategie**:
- Archiv-Pattern funktioniert gut für große Refactorings
- Schrittweises Vorgehen: Components → Hooks → Integration
- Tests nach jedem Schritt (Build-Erfolg = Validation)
- PowerShell-Direct-Write bei Tool-Problemen (create_file verdoppelt Content)

**Datei-Operationen**:
- PowerShell `Out-File` ist zuverlässiger als create_file-Tool
- Encoding immer explizit angeben (`-Encoding utf8`)
- `-NoNewline` Flag verhindert zusätzliche Leerzeile am Ende

#### 🔄 Vergleich mit EventParticipants (Point 122)

| Metric | EventParticipants | ScoreCapture | Change |
|--------|-------------------|--------------|--------|
| **Original** | 1,937 lines | 1,987 lines | - |
| **Components** | 4 files | 4 files | ✅ Equal |
| **Hooks** | 0 files | 4 files | 🆕 More hooks |
| **Final Files** | 5 total | 9 total | +4 (hooks) |
| **Avg Lines/File** | ~387 | ~137 | ✅ Better SoC |
| **Status** | ✅ Complete | 🚧 Partial | Hooks pending |

**Unterschiede**:
- ScoreCapture hat komplexere State-Management-Anforderungen → mehr Hooks
- ScoreCapture hat Formula-Calculation-Logik → eigener Hook
- EventParticipants direkter integrierbar (weniger interdependencies)
- Beide folgen gleichem Archiv-Pattern
...
```
✓ built in 10.15s
2,264 modules, 1,523 kB bundle
```

**Nach Refactoring** (mit temporärem Re-Export):
```
✓ built in 5.38s
2,265 modules (+1), 1,523 kB bundle (gleich)
```

**Verbesserung**: -47% Build-Zeit (10.15s → 5.38s)  
**Bundle**: Keine Veränderung (Tree-shaking funktioniert)
...
## Zuordnung von gymnet und turnfix ## 
Beim Import eines Events "GymNetImport" geschieht ein Mapping von Geräten welche in der XML stehen und in der DB sind. Ich meine die Zuordnung ist in der TurnFixImport.exe.config. 
Nun haben wir ja deutlich mehr Geräte durch das befüllen der DB. Aber auch hier gibt es ein mapping welches in der Zuordnungsdatei stehen muss. 
Die GymNet Id der Geräte ist hier zu finden: 
# Geräte # 
## Einzelwettkampf: ##
### P-Übung: ###
209 - Boden m. P 1 - P 9
