...
void MedalCount::print(QPrinter *printer) {
    ...
    query2.bindValue( 1, m_event->mainEvent()->id() );
    query2.exec();
...
void MedalCount::printContent() {
    printSubHeader();
    for (int i=0;i<ids.size();i++) {
        if (m_yco+mmToPixel(7.9) > max_yco) {
            newPage();
            printSubHeader();
        }
        setPrinterFont(10);
        if (i%2 != 0) drawHighlightRect(m_yco,mmToPixel(5.0));
        painter.drawText(QRectF(pr.x(), m_yco, mmToPixel(79.4), QFontMetricsF(painter.font()).height()),QString(namen.value(ids.at(i))),QTextOption(Qt::AlignVCenter));
        painter.drawText(QRectF(pr.x()+mmToPixel(80.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),QString::number(gold.value(ids.at(i))),QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
        painter.drawText(QRectF(pr.x()+mmToPixel(100.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),QString::number(silber.value(ids.at(i))),QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
        painter.drawText(QRectF(pr.x()+mmToPixel(120.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),QString::number(bronze.value(ids.at(i))),QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
        painter.drawText(QRectF(pr.x()+mmToPixel(140.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),QString::number(gold.value(ids.at(i))+silber.value(ids.at(i))+bronze.value(ids.at(i))),QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
        painter.drawText(QRectF(pr.x()+mmToPixel(160.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),QString::number(gesamt.value(ids.at(i))),QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
        m_yco += mmToPixel(5.3);
    }
    finishPrint();
}
...
void MedalCount::printSubHeader() {
    ...
    painter.drawText(QRectF(pr.x(), m_yco, mmToPixel(79.4), QFontMetricsF(painter.font()).height()),"Verein",QTextOption(Qt::AlignVCenter));
    painter.drawText(QRectF(pr.x()+mmToPixel(80.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),"Gold",QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
    painter.drawText(QRectF(pr.x()+mmToPixel(100.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),"Silber",QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
    painter.drawText(QRectF(pr.x()+mmToPixel(120.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),"Bronze",QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
    painter.drawText(QRectF(pr.x()+mmToPixel(140.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),"Summe",QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
    painter.drawText(QRectF(pr.x()+mmToPixel(160.0), m_yco,mmToPixel(20.0), QFontMetricsF(painter.font()).height()),"Starter",QTextOption(Qt::AlignVCenter | Qt::AlignHCenter));
    m_yco += mmToPixel(5.0);
