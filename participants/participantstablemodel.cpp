...
ParticipantsTableModel::ParticipantsTableModel(Event *event, QObject *parent /*= nullptr*/)
    : QSqlQueryModel(parent), m_event(event)
{
}
...
//int ParticipantsTableModel::rowCount([[maybe_unused]]const QModelIndex &parent) const
//{
//    return 0;
//}
